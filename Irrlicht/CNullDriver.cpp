...
bool CNullDriver::initDriver()
{
...

    {
        ...
        vertDecl->addElement(E_VERTEX_ELEMENT_SEMANTIC::EVES_POSITION, E_VERTEX_ELEMENT_TYPE::EVET_FLOAT3, 0, 0);
        vertDecl->initialize();
    }
...
ITexture * CNullDriver::addTextureCubemap(const io::path & name, IImage * imagePosX, IImage * imageNegX, IImage * imagePosY, IImage * imageNegY, IImage * imagePosZ, IImage * imageNegZ)
{
...
void CNullDriver::removeAllRenderTargets()
{
    ...
    {
        (*RenderTargets.begin())->drop();
        RenderTargets.erase(RenderTargets.begin());
    }
...
//! Clears the ZBuffer.
void CNullDriver::clearZBuffer(f32 clearDepth /*= 1.f*/, u8 clearStencil /*= 0*/)
{
}
