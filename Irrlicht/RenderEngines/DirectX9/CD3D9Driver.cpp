...
{
	return new CD3D9Texture(surface, this, TextureCreationFlags, name, nullptr);
}
...
ITexture * irr::video::CD3D9Driver::addTextureCubemap(const io::path & name, IImage * imagePosX, IImage * imageNegX, IImage * imagePosY, IImage * imageNegY, IImage * imagePosZ, IImage * imageNegZ)
{
    return nullptr;
}

ITexture * irr::video::CD3D9Driver::addTextureArray(const io::path & name, irr::core::array<IImage*> images)
{
    return nullptr;
}

IRenderTarget* irr::video::CD3D9Driver::addRenderTarget()
{
    return nullptr;
}

//! sets a render target
bool CD3D9Driver::setRenderTarget(ITexture* texture, u16 clearFlag /*= ECBF_COLOR | ECBF_DEPTH*/, SColor clearColor /*= SColor(255, 0, 0, 0)*/,
...
//! Clears the ZBuffer.
void CD3D9Driver::clearZBuffer(f32 clearDepth /*= 1.f*/, u8 clearStencil /*= 0*/)
{
