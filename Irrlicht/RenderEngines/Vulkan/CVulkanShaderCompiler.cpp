...
glslang::EShTargetVulkan_1_1; // would map to, say, Vulkan 1.0
...
bool irr::video::CVulkanGLSLang::CompileShader(VkShaderModule * modul, E_ShaderTypes type, System::IO::IFileReader * file, const char * entryPoint, const char* shaderModel)
{
    ...
    if (isHlsl)
    {
        _targetVersion = glslang::EShTargetSpv_1_0;    // maps to, say, SPIR-V 1.0
        //Processes.push_back("OpExtension SPV_GOOGLE_decorate_string");
        //Processes.push_back("OpExtension SPV_GOOGLE_hlsl_functionality1");
    }
    ...
    glslang::TProgram* program = new glslang::TProgram;
    {
        ...
        shader->setEnvTarget(glslang::EShTargetSpv, _targetVersion);
        //if (isHlsl)
    ...
    if (!isHlsl)
    {
        spv_target_env target_env = SPV_ENV_VULKAN_1_1; // SPV_ENV_UNIVERSAL_1_3;
