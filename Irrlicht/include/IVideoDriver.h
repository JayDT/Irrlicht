	...
	*/
	...
	public:
		...
		*/
        ...
        //! Creates a texture from an IImage.
        // Similar same with addTexture, but not store in CNULLDriver
        virtual video::ITexture* createDeviceDependentTexture(IImage* surface, const io::path& name) = 0;
		...
		*/
		virtual void clearZBuffer(f32 clearDepth = 1.f, u8 clearStencil = 0) =0;
		...
		*/
        ...
        virtual bool SetShader(IShader* gpuProrgam) = 0;
