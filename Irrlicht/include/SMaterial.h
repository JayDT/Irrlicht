...
namespace video
{
	...
	*/
    ...
    {
        SStencil()
            : Comparsion(E_COMPARISON_FUNC::ECFN_NEVER)
            , DepthFailOp(E_STENCIL_OPERATION::ESO_KEEP)
            , PassOp(E_STENCIL_OPERATION::ESO_KEEP)
            , FailOp(E_STENCIL_OPERATION::ESO_KEEP)
            , Mask(0)
            , WriteMask(0)
            , Reference(0)
        {
	...
	public:
		...
		:   MaterialType(EMT_SOLID), AmbientColor(255,255,255,255), DiffuseColor(255,255,255,255),
            ...
            StencilTest(false), IsCCW(false), ScissorEnable(false)
		{ 
            VertexShaderId = -1;
            PixelShaderId = -1;
        }
		...
		E_MATERIAL_TYPE MaterialType : 8;
