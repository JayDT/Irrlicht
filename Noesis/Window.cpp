...
////////////////////////////////////////////////////////////////////////////////////////////////////
NS_REGISTER_REFLECTION(Application, Window)
{
	NS_REGISTER_COMPONENT(Window)
	
	NS_REGISTER_COMPONENT(Noesis::EnumConverter<ResizeMode>)
	NS_REGISTER_COMPONENT(Noesis::EnumConverter<WindowState>)
	NS_REGISTER_COMPONENT(Noesis::EnumConverter<WindowStyle>)
	NS_REGISTER_COMPONENT(Noesis::EnumConverter<WindowStartupLocation>)
}

////////////////////////////////////////////////////////////////////////////////////////////////////
Window::Window(): mDisplay(), mRenderContext(), mWindowFlags(0), mViewFlags(0), mActiveView(0),
    mIsCtrlDown(false), mIsShiftDown(false), mStatsMode(StatsMode_Disabled), mToolbar(0),
    mWireframeBtn(0), mBatchesBtn(0), mOverdrawBtn(0), mPPAABtn(0), mStatsBtn(0),
    mWaitToHideToolbar(0)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void Window::Init(IrrNsDeviceStub* display, IrrRenderContext* context, uint32_t samples, bool ppaa)
{
    mDisplay = Noesis::Ptr<IrrNsDeviceStub>(display);
    mRenderContext = Noesis::Ptr<IrrRenderContext>(context);
    mSamples = samples;
    mPPAA = ppaa;
	...
	OnDisplaySizeChanged(display, display->GetClientWidth(), display->GetClientHeight());
...
void Window::Render(double time)
{
    ...
    mRenderContext->SetDefaultRenderTarget(mDisplay->GetClientWidth(), mDisplay->GetClientHeight());
    renderer->Render();
    RenderStats(time);
}
...
void NoesisApp::Window::OnQueryCursor(const Noesis::QueryCursorEventArgs& e)
{
}
...
bool Window::CoerceBackground(const DependencyObject* object, const void* in, void* out)
{
    ...
    if (clearColor != 0)
    {
        IrrRenderContext* renderContext = window->mRenderContext;
        if (renderContext != 0)
        {
