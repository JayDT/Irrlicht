...
namespace NoesisApp
{
    ...
    private:
        ...
        void OnDisplayLocationChanged(IrrNsDeviceStub* display, int x, int y);
        void OnDisplaySizeChanged(IrrNsDeviceStub* displa, uint32_t width, uint32_t height);
        void OnDisplayFileDropped(IrrNsDeviceStub* display, const char* filename);
        void OnDisplayActivated(IrrNsDeviceStub* display);
        void OnDisplayDeactivated(IrrNsDeviceStub* display);
        void OnDisplayMouseMove(IrrNsDeviceStub* display, int x, int y);
        void OnDisplayMouseButtonDown(IrrNsDeviceStub* display, int x, int y, Noesis::MouseButton b);
        void OnDisplayMouseButtonUp(IrrNsDeviceStub* display, int x, int y, Noesis::MouseButton b);
        void OnDisplayMouseDoubleClick(IrrNsDeviceStub* display, int x, int y, Noesis::MouseButton b);
        void OnDisplayMouseWheel(IrrNsDeviceStub* display, int x, int y, int delta);
        void OnDisplayMouseHWheel(IrrNsDeviceStub* display, int x, int y, int delta);
        void OnDisplayScroll(IrrNsDeviceStub* display, float value);
        void OnDisplayHScroll(IrrNsDeviceStub* display, float value);
        void OnDisplayTouchDown(IrrNsDeviceStub* display, int x, int y, uint64_t id);
        void OnDisplayTouchMove(IrrNsDeviceStub* display, int x, int y, uint64_t id);
        void OnDisplayTouchUp(IrrNsDeviceStub* display, int x, int y, uint64_t id);
