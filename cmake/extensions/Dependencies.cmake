...
include(MacroLogFeature REQUIRED)
...
if(PROJECT_BUILD_DEPENDENCIES AND NOT EXISTS ${PROJECTDEPS_PATH})
    ...
    if(NOT BUILD_IN_USE_GLSLANG AND (Vulkan_FOUND OR MSVC OR MINGW)) # other platforms dont need this
        ...
        execute_process(COMMAND ${CMAKE_COMMAND}
            -E tar xf SPIRV-Tools-master.tar.gz WORKING_DIRECTORY ${CMAKE_BINARY_DIR})
        #file(DOWNLOAD
        #    https://github.com/KhronosGroup/SPIRV-Headers/archive/vulkan-1.1-rc2.tar.gz
        ...
        execute_process(COMMAND ${CMAKE_COMMAND}
            ...
            -DCMAKE_BUILD_TYPE=${DEP_BUILD_TYPE}
            -DBUILD_SHARED_LIBS=${PROJECTDEPS_SHARED}
            -DSPIRV-Headers_SOURCE_DIR=$ENV{VULKAN_SDK}/spirv-tools/external/spirv-headers
            -G ${CMAKE_GENERATOR}
            -DCMAKE_GENERATOR_PLATFORM=${CMAKE_GENERATOR_PLATFORM}
            ${CROSS}
...
if (NOT BUILD_IN_USE_GLSLANG) # DEPLOY_GLSLANG
    ...
    set(Glslang_LIBRARY glslang SPIRV SPVRemapper HLSL OSDependent SPIRV-Tools.lib)
...
IF (BUILD_EXAMPLES)
    ...
    file(COPY ${CMAKE_BINARY_DIR}/Dependencies/lib/ DESTINATION ${LIBS_DIR} PATTERN *.*)
ENDIF()
