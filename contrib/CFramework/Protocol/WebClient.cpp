...
//}
//
//double WebClient::GetInfo(uint32_t _info)
//{
//    if (m_result != CURLE_OK)
//        return 0.0;
//
//    double val = 0.0;
//    CURLcode res = curl_easy_getinfo(m_curl_handle, (CURLINFO)_info, &val);
...
//            m_url.c_str(), curl_easy_strerror((CURLcode)m_result));
//    }
//
