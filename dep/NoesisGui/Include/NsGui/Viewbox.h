...
public:
    ...
    static Point GetStretchScale(const Size& elementSize,
        const Size& availableSize, Stretch stretch,
...
private:
    Size GetStretchSize(const Size& childSize,
        const Size& availableSize, Point& scale);
