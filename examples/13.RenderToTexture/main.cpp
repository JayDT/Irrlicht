	...
	*/
	...
	if (device->isWindowActive())
	{
		...
		if (renderTarget)
		{
			...
			driver->setRenderTargetEx(renderTarget, video::ECBF_COLOR | video::ECBF_DEPTH | video::ECBF_STENCIL, video::SColor(0,0,0,255));
			...
			driver->setRenderTargetEx(0, video::ECBF_COLOR | video::ECBF_DEPTH | video::ECBF_STENCIL, video::SColor(0));
