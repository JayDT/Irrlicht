...
////////////////////////////////////////////////////////////////////////////////////////////////////
NS_REGISTER_REFLECTION(WorldClient, OptionSelector)
{
	NS_REGISTER_COMPONENT(OptionSelector)
}
...
{
    GUI::LoadComponent(this, "pack://application:,,,/32.NoesisGUI;/UI/OptionSelector.xaml");
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
NS_IMPLEMENT_REFLECTION(WorldClient::OptionSelector)
{
    NsMeta<TypeId>("WorldClient.OptionSelector");
